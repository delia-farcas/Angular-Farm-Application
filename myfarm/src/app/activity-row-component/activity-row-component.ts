...
@Component({
  ...
  template: `
    @if (type === 'observation') {
      ...
      <td><span class="risk-badge" [attr.data-risk]="data.riskLevel">{{ data.riskLevel }}</span></td>
      ...
      <td><span class="status-badge" [class.error]="data.statusCode >= 400">{{ data.statusCode }}</span></td>
    }
  `,
