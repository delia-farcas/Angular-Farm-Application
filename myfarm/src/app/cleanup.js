    ...
    sourceFile.getClasses().forEach((c) => {
      ...
      c.getMethods().forEach((m) => {
        ...
        if (name === 'ngOnInit') desc = 'Initializes the component.';
          ...
          desc = 'Retrieves the ' + toSentence(name.substring(3)).trim() + '.';
        else if (name.startsWith('set'))
          desc = 'Sets the ' + toSentence(name.substring(3)).trim() + '.';
        else if (name.startsWith('navigate'))
          desc = 'Navigates to ' + toSentence(name.substring(8)).trim() + '.';
        else if (name.startsWith('on'))
          desc = 'Handles the ' + toSentence(name.substring(2)).trim() + ' event.';
